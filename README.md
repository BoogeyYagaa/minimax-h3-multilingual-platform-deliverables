...
|---|---|---|---|---|
| en-US | Product launch videos | PromoteProject | [`minimax-h3-product-launch-indiehackers-en`](./minimax-h3-product-launch-indiehackers-en/) | [Manifest V2 published and verified](https://www.promoteproject.com/article/226203/minimax-h3-product-launch-videos-7-honest-clips-for-founders) — replacement for blocked Indie Hackers submission |
| es-419 | Travel and food videos | Dreamwidth | [`minimax-h3-travel-journal-dreamwidth-es`](./minimax-h3-travel-journal-dreamwidth-es/) | [Published; live update blocked by 403](https://bestimage.dreamwidth.org/482.html) |
| pt-BR | E-commerce UGC videos | Blogger | [`minimax-h3-ugc-guide-guides-ptbr`](./minimax-h3-ugc-guide-guides-ptbr/) | [Manifest V2 published and verified](https://bestimage-ai-video-notes.blogspot.com/2026/08/minimax-h3-7-roteiros-ugc-para-testar.html) — replacement for invite-only Guides.co |
...
| de-DE | SaaS explainer videos | Substack | [`minimax-h3-saas-explainer-dev-de`](./minimax-h3-saas-explainer-dev-de/) | [Manifest V2 published and verified](https://bestimage.substack.com/p/saas-erklarvideos-mit-minimax-h3) — replacement for suspended DEV account |
