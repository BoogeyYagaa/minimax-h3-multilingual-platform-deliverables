...
MiniMaxの[公式動画生成ドキュメント](https://platform.minimax.io/docs/guides/video-generation)では、H3はテキスト、画像、動画、音声を入力として扱い、768Pまたは2K、4〜15秒の出力に対応すると説明されています。仕様は尺を決める材料になりますが、キャラクターや小道具の正確さを保証するものではありません。

## まず15秒を役割に分ける

例として、15秒を次のように割り振ります。

時間 役割 観客に残したい情報 0〜3秒 世界への入口 場所、時間、色、音 3〜7秒 キャラクター 顔、姿勢、衣装、感情 7〜11秒 変化 1つの動作や事件の前兆 11〜13秒 余韻 次を見たくなる停止点 13〜15秒 編集用の空間 タイトル、日付、ロゴを後から追加
...
項目 固定する内容 カット後の判定 髪 長さ、色、分け目 一致 / 要修正 衣装 色、丈、襟、左右 一致 / 要修正 小道具 形、持つ手、向き 一致 / 要修正 カメラ 高さ、距離、移動方向 一致 / 要修正 光 主光源、色温度、影 一致 / 要修正 音 雨、足音、機械音の密度 一致 / 要修正 終了姿勢 次のカットへの接続点 使用可 / 再生成
...
関連する第三者サービスを比較する場合は、[Affordable MiniMax H3 API](https://bestimage.ai/models/minimax/minimax-h3-text-to-video/?via=shixi88)も候補になります。ただしMiniMax公式サービスではなく、リンクにはトラッキングパラメータが含まれます。価格、モデル提供状況、プライバシー、出力物の利用条件は、利用前に各自で確認してください。
...
[#MiniMax H3](https://www.tumblr.com/bestimageai/tagged/MiniMax%20H3) [#アニメPV](https://www.tumblr.com/bestimageai/tagged/%E3%82%A2%E3%83%8B%E3%83%A1PV) [#AI動画](https://www.tumblr.com/bestimageai/tagged/AI%E5%8B%95%E7%94%BB) [#プロンプト](https://www.tumblr.com/bestimageai/tagged/%E3%83%97%E3%83%AD%E3%83%B3%E3%83%97%E3%83%88) [#映像制作](https://www.tumblr.com/bestimageai/tagged/%E6%98%A0%E5%83%8F%E5%88%B6%E4%BD%9C)
