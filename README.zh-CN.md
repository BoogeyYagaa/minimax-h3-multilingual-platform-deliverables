...
目前已有四篇文章在最终平台公开发布并完成页面核对。其余文件仍是编辑交付物、暂停投稿或平台访问申请，具体状态如下。
...
| ja-JP | 动漫宣传视频 | 待重新确定 | [`minimax-h3-anime-pv-hatena-ja`](./minimax-h3-anime-pv-hatena-ja/) | 暂停：Hatena、note 与 Livedoor 均受阻，Tumblr 按用户要求搁置 |
| de-DE | SaaS 讲解视频 | DEV | [`minimax-h3-saas-explainer-dev-de`](./minimax-h3-saas-explainer-dev-de/) | 已发送账号申诉，等待 DEV 回复；仍需人工技术复核 |
...
- 已发布的 PromoteProject 改写版是有记录的例外：线上正文包含一个已披露的第三方跟踪链接，本地 Indie Hackers 原始平台包保持不变。
- Guides.co 已确认收到贡献申请；获得邀请与发布权限前仍保持暂停。
- DEV 账号暂停申诉已发送；投稿仍被阻塞，文章恢复投稿前仍须完成人工技术复核。
