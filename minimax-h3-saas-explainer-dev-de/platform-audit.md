...
| Publication status | Hold | The logged-in DEV account returned `Forbidden` on 2026-08-17 because it is suspended. Human technical and policy responsibility remains required after access is restored. |
...
- Remaining risk: DEV must restore posting access, and only the human publisher can satisfy DEV’s requirement to understand and stand behind the technical content.
