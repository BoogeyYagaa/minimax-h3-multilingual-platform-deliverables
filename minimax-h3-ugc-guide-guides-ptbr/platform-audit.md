...
- Reader: Brazilian e-commerce teams planning product demonstrations.
- Type: maintainable step-by-step guide.
- Core idea: seven UGC-style scripts without fake testimonials.
- Main phrase: roteiros UGC para produtos.
- Tone: practical, neutral, checklist-driven.
- Must include: preparation, scripts, prompt template, versioning, product review, campaign archive.
- Must avoid: fabricated social proof, health claim, commercial CTA, affiliate link.
- Source: MiniMax official documentation and Guides.co official access/terms pages.
- Output: `pt-BR` Markdown ready for chapter entry after access approval.
