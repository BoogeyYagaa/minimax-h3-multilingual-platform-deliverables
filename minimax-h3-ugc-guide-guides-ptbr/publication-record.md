...
- **Title:** MiniMax H3: 7 roteiros UGC para testar vídeos de produtos
- **Replacement path:** Blogger replaced the invite-only Guides.co submission path.

## Public-page verification

- Complete Brazilian Portuguese article body displayed with six main workflow stages and seven UGC script patterns.
- Portuguese accents and punctuation rendered correctly after the HTML editor was revalidated.
