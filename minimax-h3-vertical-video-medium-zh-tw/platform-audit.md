...
**DRAFT SAVED — IMAGE UPLOAD REQUIRED**。正文已按 Medium 的编辑型长文重构，保留繁中 Locale，删除商业 CTA 与跟踪参数。2026年8月17日重试后草稿能够保存，但 4 张本地图片尚未上传，因此仍不具备发布条件。
...
6. 将本包 4 张图片上传到已保存草稿，并逐张检查章节位置、图片说明与替代文字。
