...
若要比較官方入口以外的使用方式，可查看 [Best Image AI 的 MiniMax H3 API 選項](https://bestimage.ai/models/minimax/minimax-h3-text-to-video/?via=shixi88)。Best Image AI 是第三方服務，`via=shixi88` 是追蹤參數；這段連結不代表價格最低，也不保證各地區即時可用，使用前仍要重查功能與條件。
